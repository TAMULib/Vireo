...
public class SubmissionEmailServiceTest extends MockData {
    ...
    private static final SubmissionStatus TEST_SUBMISSION_STATUS2 = new SubmissionStatus("Test Submission Status 2", true, false, false, false, false, false, false, false, SubmissionState.CANCELLED, new ArrayList<SubmissionStatus>());
