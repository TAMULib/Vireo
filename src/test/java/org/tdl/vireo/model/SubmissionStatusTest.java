...
public class SubmissionStatusTest extends AbstractEntityTest {
    ...
    public void testCreate() {
        ...
        assertEquals("The submission state did not contain the correct clear approval!", TEST_PARENT_SUBMISSION_STATUS_CLEAR_APPROVAL, parentSubmissionState.getClearApproval());
        ...
        assertEquals("The submission state did not contain the correct clear approval!", TEST_TRANSITION_SUBMISSION_STATUS_CLEAR_APPROVAL, transitionSubmissionState.getClearApproval());
    }

    @Override
    public void testDuplication() {
        submissionStatusRepo.create(TEST_PARENT_SUBMISSION_STATUS_NAME, TEST_PARENT_SUBMISSION_STATUS_ARCHIVED, TEST_PARENT_SUBMISSION_STATUS_PUBLISHABLE, TEST_PARENT_SUBMISSION_STATUS_DELETABLE, TEST_PARENT_SUBMISSION_STATUS_EDITABLE_BY_REVIEWER, TEST_PARENT_SUBMISSION_STATUS_EDITABLE_BY_STUDENT, TEST_PARENT_SUBMISSION_STATUS_ACTIVE, TEST_PARENT_SUBMISSION_STATUS_DEFAULT, TEST_PARENT_SUBMISSION_STATUS_CLEAR_APPROVAL, null, new ArrayList<SubmissionStatus>());
        try {
            submissionStatusRepo.create(TEST_PARENT_SUBMISSION_STATUS_NAME, TEST_PARENT_SUBMISSION_STATUS_ARCHIVED, TEST_PARENT_SUBMISSION_STATUS_PUBLISHABLE, TEST_PARENT_SUBMISSION_STATUS_DELETABLE, TEST_PARENT_SUBMISSION_STATUS_EDITABLE_BY_REVIEWER, TEST_PARENT_SUBMISSION_STATUS_EDITABLE_BY_STUDENT, TEST_PARENT_SUBMISSION_STATUS_ACTIVE, TEST_PARENT_SUBMISSION_STATUS_DEFAULT, TEST_PARENT_SUBMISSION_STATUS_CLEAR_APPROVAL, null, new ArrayList<SubmissionStatus>());
    ...
    public void testCascade() {
        ...
        SubmissionStatus grandchildTransitionSubmissionStatus = submissionStatusRepo.create(TEST_TRANSITION2_SUBMISSION_STATUS_NAME, TEST_TRANSITION_SUBMISSION_STATUS_ARCHIVED, TEST_TRANSITION_SUBMISSION_STATUS_PUBLISHABLE, TEST_TRANSITION_SUBMISSION_STATUS_DELETABLE, TEST_TRANSITION_SUBMISSION_STATUS_EDITABLE_BY_REVIEWER, TEST_TRANSITION_SUBMISSION_STATUS_EDITABLE_BY_STUDENT, TEST_TRANSITION_SUBMISSION_STATUS_ACTIVE, TEST_PARENT_SUBMISSION_STATUS_DEFAULT, TEST_PARENT_SUBMISSION_STATUS_CLEAR_APPROVAL, null, new ArrayList<SubmissionStatus>());
